    ...
    ui(new Ui::LoginDialog)
{
    ...
    //连接登tcp管理者发出的登录成功信号
    connect(TcpMgr::GetInstance().get(), &TcpMgr::sig_login_ok, this, &LoginDialog::slot_login_ok);
    //连接登tcp管理者发出的登录失败信号
...
void LoginDialog::initHead()
{
    ...
    painter.setRenderHint(QPainter::SmoothPixmapTransform);// 设置平滑
...
void LoginDialog::slot_login_ok()
{
    qDebug()<<"登录成功，正在跳转页面";
