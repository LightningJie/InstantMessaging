    ...
    ui(new Ui::RegisterDialog),_countdown(5)
{
    ...
    repolish(ui->err_tip);
    connect(HttpMgr::GetInstance().get(),&HttpMgr::sig_reg_mod_finish,this ,&RegisterDialog::slot_reg_mod_finfish);
    initHttpHandlers();
    ui->err_tip->clear();
    ...
    connect(ui->pass_visible, &ClickedLabel::clicked, this, [this]() {
        ...
        if(state == ClickLbState::Normal){
            ui->pass_edit->setEchoMode(QLineEdit::Password);//****
                ...
                ui->pass_edit->setEchoMode(QLineEdit::Normal);//123456
        }
...
void RegisterDialog::slot_reg_mod_finfish(ReqId id, QString res, ErrorCodes err)
{
    if(err!=ErrorCodes::SUCCESS){
        showTip("网络请求无效",false);
        return;
    }
